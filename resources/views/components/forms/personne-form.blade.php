<div>
    ...
    <x-form-elements.form-input name="prenom" label="Prénom" wire:model="prenom" />
    <x-form-elements.form-group class="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <x-form-elements.form-input name="date_naissance" label="Date de naissance" wire:model="date_naissance" placeholder="AAAA, AAAA-MM ou AAAA-MM-JJ" />
    ...
    <x-form-elements.form-group class="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <x-form-elements.form-input name="date_deces" label="Date de décès" wire:model="date_deces" placeholder="AAAA, AAAA-MM ou AAAA-MM-JJ" />
            <x-form-elements.form-group>
    ...
    <x-form-elements.form-select name="sexe" label="Sexe" wire:model="sexe">
            <option value="">Sélectionner</option>
            <option value="M">Masculin</option>
            <option value="F">Féminin</option>
            <option value="X">Autre</option>
        </x-form-select>
    <x-form-elements.form-input name="titre" label="Titre" wire:model="titre" />
