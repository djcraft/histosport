<div>
    ...
    <x-form-elements.form-input name="titre" label="Titre" wire:model="titre" required />
    <x-form-elements.form-input name="auteur" label="Auteur" wire:model="auteur" />
    <x-form-elements.form-group class="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <x-form-elements.form-input name="annee_reference" label="Année de référence" wire:model="annee_reference" placeholder="AAAA, AAAA-MM ou AAAA-MM-JJ" />
            <x-form-elements.form-input name="type" label="Type" wire:model="type" />
        </x-form-group>
    <x-form-elements.form-group class="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <x-form-elements.form-input name="cote" label="Cote" wire:model="cote" />
            <x-form-elements.form-input name="url" label="URL" wire:model="url" />
        </x-form-group>
    <x-form-elements.form-group class="mb-4 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="flex justify-end gap-2">
            ...
            <x-buttons.button type="button" variant="success" wire:click="$dispatch('openLieuModal')">Créer un lieu</x-buttons.button>
        </div>
    </form>
    <livewire:lieu-modal />
